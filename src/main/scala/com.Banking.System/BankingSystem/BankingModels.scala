...
case class Transaction(id: Option[Int], sourceAccount: Account, destinationAccount: Account, amount: Double, date: Date = new Date(), transactionType: TransactionType)
